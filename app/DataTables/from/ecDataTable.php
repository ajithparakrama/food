...
class ecDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        ...
        ->addColumn('action',  function($item){
                $btn = '<a href="'.route('from-ecs.edit',[$this->district->id,$item->id]).'" class="btn btn-xs btn-info" > <i class="fa fa-pen"></i></a>';
                return $btn; 
        })
        ->setRowId('id');
    }
     ...
     */
    public function query(fromEcs $model): QueryBuilder
    {
