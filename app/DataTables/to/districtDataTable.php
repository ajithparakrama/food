...
class districtDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->addColumn('action',  function($item){
                    $btn = '<a href="'.route('to-district.edit',[$this->district->id,$item->id]).'" class="btn btn-xs btn-info" > <i class="fa fa-pen"></i></a>';
                    return $btn; 
            })
            ->setRowId('id');
    }
     ...
     */
    public function query(toDistricts $model): QueryBuilder
    {
     //   return $model->newQuery();
       ...
       // 'districts.name as district'
        ...
        ->where('district_id', $this->district->id)->with('crop','toLocation'); 
    }
