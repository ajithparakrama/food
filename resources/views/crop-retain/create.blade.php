        ...
        <div>
            ...
            <div class="card">
                <div class="card-header">
                    <div class="card-title">Cultivation/Harvest Details</div>
                    <div class="card-tools">
                        <a href="{{ URL::previous() }}" class="btn btn-sm btn-dark">Back</a>
                    </div>
                </div>

                <form role="form" method="POST" action="{{ route('cultivation.store',$district->id) }}"
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <select class="form-control select2 @error('crop_id') is-invalid @enderror" name="crop_id">
                                    ...
                                    @foreach ($crops as $item)
                                        <option value="{{ $item->id }}" @if ($item->id==old('crop_id'))
                                          @selected(true)  
                            ...
                            <div class="col-sm-4">
                                <input type="date" name="cultivated_date" value="{{ old('cultivated_date') }}" class="form-control @error('cultivated_date') is-invalid @enderror"  id="">
                            ...
                            <div class="col-sm-4">
                                <input type="text" name="cultivated_land" value="{{ old('cultivated_land') }}" class="form-control @error('cultivated_land') is-invalid @enderror" id="">
                            ...
                            <div class="col-sm-4">
                                <input type="text" name="actual_harvest_mt" value="{{ old('actual_harvest_mt') }}" class="form-control @error('actual_harvest_mt') is-invalid @enderror" id="actual_harvest_mt">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                               <input type="text" value="{{ old('cultivation_changes_ha') }}" class="form-control text-right @error('cultivation_changes_ha') is-invalid @enderror"  name="cultivation_changes_ha" id="cultivation_changes_ha" placeholder="Ha">
                            ...
                            <div class="col-sm-4">
                                <select class="form-control select2 @error('reason_for_changes') is-invalid @enderror" name="reason_for_changes">
                                    <option></option>
                                    <option>Pest/Disease Damages</option>
                                  <option>Wet weather</option>
                                   <option>Dry weather</option>
                                  <option>Wild animal attack</option>
                                   <option>Other damages</option>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <input type="text" name="total_retain" value="{{ old('total_retain') }}"
                            ...
                            <div class="col-sm-4">
                                <input type="text" name="total_retain_mt" readonly value="{{ old('total_retain_mt') }}"
