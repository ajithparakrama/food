    ...
    <div class="container-fluid">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1> {{ $district->name }} To Ecs</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="#">Home</a></li>
                            <li class="breadcrumb-item ">  {{ $district->name }} To Ecs</li>
        ...
        <div>
            ...
            <div class="card">
                ...
                <form role="form" method="POST" action="{{ route('to-ecs.store',$district->id) }}"
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <input type="date" name="month" class="form-control @error('month') is-invalid @enderror" value="{{ old('month') }}" id="">
                                @error('month')
                                <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
